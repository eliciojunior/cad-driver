...
<body>
  ...
  <nav class="navbar navbar-expand-md fixed-top navbar-dark bg-dark">
    <a class="navbar-brand" href="#">CadDriver | Welcome <? print $_SESSION['usuarioNome']; ?></a>
  ...
  <div class="content">
    <!-- DATATABLE -->
    <div class="datatable">
    <table id="motoristas" class="table table-striped table-bordered responsive nowrap" style="width:100%">
      <thead>
        <tr>
          <th>Name</th>
          <th>Position</th>
